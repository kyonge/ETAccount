...
typedef enum : NSUInteger {
    ETACCOUNT_GRAPH_OPTION_TYPE,
    ETACCOUNT_GRAPH_OPTION_KIND,
} ETACCOUNT_GRAPH_OPTION;

typedef enum : NSUInteger {
//    ETACCOUNT_GRAPH_TYPE_DEFAULT,
    ETACCOUNT_GRAPH_TYPE_EACH_TOTAL,
    ETACCOUNT_GRAPH_TYPE_DAILY_FLOW,
} ETACCOUNT_GRAPH_TYPE;

typedef enum :NSUInteger {
    ETACCOUNT_GRAPH_KIND_SQUARE,
    ETACCOUNT_GRAPH_KIND_LINE,
} ETACCOUNT_GRAPH_KIND;
